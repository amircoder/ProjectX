...
/******************************************************
 * Just some dummy data used in unit tests
 ******************************************************/
...
val SOME_JOB_RESPONSE_TEMS = listOf(SOME_JOB_RESPONSE)
val SOME_OTHER_JOB_RESPONSE_TEMS = listOf(SOME_OTHER_JOB_RESPONSE)
